...
about: Describe something c_exception currently doesn't do that you'd like it to — or does
...
2. Please delete sections from this template that do not apply to your particular enhancement request.
...
**What doesn't c_exception currently do (or does do, but not in a way you'd like)?**

**What would you like c_exception to do (instead)?**
